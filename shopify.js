...
module.exports = (function () {
    function run(req) {
    	var entity = req.reqData.entity;
    	var apiKey,apiPassword;
    	var args = {
        ...
        if(type==customer) {
     	...
     	getStoreData(url,args, type, req);  	
    }
	   var Shopify = {
	    init: function (req) {
	        //initial function to get request data
	        var credentials = req.reqData.credentials;
...
function post(resArr, req) {
	console.log("****************RESPONSE**************  %j",resArr);
	req.reqData.preData = resArr;
